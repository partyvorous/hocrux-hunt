...
export const STAGES: Stage[] = [
  {
    ...
    clue:
      "Where comfort fades and shadows stack,\nSeek the throne that shuns the track.\nNot where eyes first drift or land,\nBut where silence claims the farthest stand.\n\nPast the chatter, past the light,\nLurks your clue just out of sight.\nAmong the seats, but not in show—\nFind the one the last winds know.",
    riddleLines: [
      "Where comfort fades and shadows stack,",
      "Seek the throne that shuns the track.",
      "Not where eyes first drift or land,",
